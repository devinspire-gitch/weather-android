package com.canada.weather.Service;

import com.canada.weather.model.currentweather.CurrentWeatherResponse;
import com.canada.weather.model.daysweather.MultipleDaysWeatherResponse;
import com.canada.weather.model.fivedayweather.FiveDayResponse;
...
//     * @param q     String name of city
     * @param lat String lat of city
     * @param lon String longt of city
